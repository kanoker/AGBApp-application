...
class DepartmentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Department entity")
        ...
        .repeat(2) {
            ...
            .get("/services/agbapp/api/departments")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new department")
            .post("/services/agbapp/api/departments")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
            ...
            .repeat(5) {
                ...
                .get("/services/agbapp${new_department_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created department")
            .delete("/services/agbapp${new_department_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
