...
class JobHistoryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the JobHistory entity")
        ...
        .repeat(2) {
            ...
            .get("/services/agbapp/api/job-histories")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new jobHistory")
            .post("/services/agbapp/api/job-histories")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
            ...
            .repeat(5) {
                ...
                .get("/services/agbapp${new_jobHistory_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created jobHistory")
            .delete("/services/agbapp${new_jobHistory_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
