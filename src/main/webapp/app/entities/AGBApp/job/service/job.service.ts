...
export class JobService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/jobs', 'agbapp');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/jobs', 'agbapp');
