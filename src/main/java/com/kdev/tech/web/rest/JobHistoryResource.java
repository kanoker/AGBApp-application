...
import com.kdev.tech.domain.JobHistory;
import com.kdev.tech.repository.JobHistoryRepository;
import com.kdev.tech.service.JobHistoryService;
...
/**
 * REST controller for managing {@link com.kdev.tech.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
public class JobHistoryResource {
    ...
    private static final String ENTITY_NAME = "agbAppJobHistory";
