...
@RestController
@RequestMapping("/api/agb-app-kafka")
public class AgbAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AgbAppKafkaResource.class);
    ...
    public AgbAppKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
